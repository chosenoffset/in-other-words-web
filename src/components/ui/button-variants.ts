  ...
  'inline-flex items-center justify-center rounded-lg font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none ring-offset-background border relative overflow-hidden group interactive-button animate-gpu',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-red-600 bg-gradient-to-r from-red-600 to-red-700 text-white hover:shadow-lg hover:shadow-red-500/25 hover:-translate-y-0.5',

        ghost:
          'bg-transparent text-gray-500 dark:text-gray-400 border-gray-300 dark:border-gray-600 hover:text-red-600 hover:border-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 hover:scale-105 transition-all duration-300',

        signin:
          'border-sky-500 bg-gradient-to-r from-sky-500 to-blue-600 text-white hover:shadow-lg hover:shadow-sky-500/25 hover:-translate-y-0.5',

        submit:
          'border-sky-500 bg-gradient-to-r from-sky-500 to-blue-600 text-white hover:shadow-lg hover:shadow-sky-500/25 hover:-translate-y-0.5 disabled:bg-slate-400 disabled:border-slate-400 disabled:cursor-not-allowed text-base font-medium',

        retry:
          'border-sky-500 bg-gradient-to-r from-sky-500 to-blue-600 text-white hover:shadow-lg hover:shadow-sky-500/25 hover:-translate-y-0.5 text-sm',
        ...
        'game-primary':
          'bg-blue-600 text-white shadow-lg hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/25 hover:-translate-y-1 hover:scale-105 active:scale-100 transition-all duration-300',

        'hint-reveal':
          'bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 hover:shadow-lg hover:shadow-purple-500/25 hover:-translate-y-0.5 disabled:from-gray-300 disabled:to-gray-400 transition-all duration-300',

        success:
          'bg-gradient-success text-white hover:shadow-lg hover:shadow-green-500/25 hover:-translate-y-0.5 animate-success-bounce',
