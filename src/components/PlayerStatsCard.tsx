    ...
    <div className="stats-card">
      <SignedOut>
        <div className="stats-unauthenticated">
          ...
          <p>Sign in to track your puzzle-solving statistics and see your progress over time.</p>
        ...
        <div className="stats-content">
          ...
          {stats && (
            <div className="stats-grid">
              ...
              <div className="stat-item">
                <div className="stat-value">{stats.averageGuesses.toFixed(1)}</div>
              ...
              <div className="stat-item">
                <div className="stat-value">{formatTime(stats.fastestSolveMs)}</div>
                <div className="stat-label">Best Time</div>
              </div>

              <div className="stat-item stat-item-wide">
                <div className="stat-value">{formatDate(stats.lastPlayedAt)}</div>
