      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-center p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-muted font-medium typing-indicator">Loading puzzle...</span>
          </div>
        </div>
      </div>
    )
      ...
      {submissionResult && (
        <div
          className={`
            ...
            ${submissionResult.isCorrect ? 'confetti-pop' : 'card-flip'}
        ...
        >
          ...
          <div className={`flex items-start gap-4 ${submissionResult.isCorrect ? 'celebration-bounce' : 'answer-incorrect'}`}>
            <div className={`
          ...
          {submissionResult.hint && submissionResult.hint.length > 0 && (
            <div className="mt-4 p-4 bg-white/50 dark:bg-black/20 rounded-lg border border-blue-200 dark:border-blue-700 animate-fade-in">
              ...
              <div className="text-blue-700 dark:text-blue-300">{submissionResult.hint}</div>
            </div>
          )}
        ...
        <div className="inline-flex items-center gap-3 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
              Guesses: {attemptStatus ? `${attemptStatus.attemptCount}/${attemptStatus.maxGuesses}` : '0/5'}
            </span>
          </div>

          {attemptStatus && attemptStatus.remainingGuesses > 0 && attemptStatus.attemptCount > 0 && (
          ...
          {attemptStatus && attemptStatus.remainingGuesses === 0 && !submissionResult?.isCorrect && (
            <div className="flex items-center gap-1">
