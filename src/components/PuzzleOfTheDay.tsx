    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-full border border-gray-300 dark:border-gray-600 animate-fade-in">
          <svg className="h-4 w-4 text-gray-700 dark:text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 animate-slide-in-up">
          Today&apos;s Puzzle
        </h2>
      </div>
      ...
      <div className="relative">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg p-6 shadow-sm animate-reveal-hint">
          ...
          <p className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100 leading-relaxed italic pl-4">
            {puzzle.question}
          </p>
        </div>
      </div>
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 text-muted animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <svg className="h-5 w-5 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
          </svg>
          <span className="font-medium text-gray-700 dark:text-gray-300">What phrase is this clue describing?</span>
        </div>
      </div>
    </div>
  )
